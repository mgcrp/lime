...
class LimeImageExplainer(object):
    ...
    def prepare_for_explanation(self, image, save_dir,
                         hide_color=None,
                         num_samples=1000,
                         segmentation_fn=None,
                         distance_metric='cosine',
    ...
    def restore_explanation(self, state, probas,
        ...
        Args:
            state: an instance of LimeImageExplainerState, recieved from
                prepare_for_explanation method
            probas: numpy array with predicted probas
            labels: iterable with labels to be explained.
            top_labels: if not None, ignore labels and produce explanations for
                the K labels with highest prediction probabilities, where K is
                this parameter.
